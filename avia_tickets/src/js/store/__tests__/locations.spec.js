...
jest.mock('../../services/apiService', () => {
  const mockApi = {
    ...
    airlines: jest.fn(() =>
      Promise.resolve([
        { country_code: 'UKR', name: 'Airlines', code: 'AVIA' },
      ]),
    ),
  };
...
describe('Locations store tests', () => {
  ...
  it('Check that locationInstance is instance of Locations', () => {
  ...
  it('Check countries serialize with uncorrect data', () => {
  ...
  it('Check cities serialize with uncorrect data', () => {
  ...
  it('Check correct init methos call', () => {
